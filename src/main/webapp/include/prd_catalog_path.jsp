...
%>
    <div class="row">
      ...
      <% if (product_catalogue.getColumn("catDescr" + lang).length()>0 && !whereAmI.equals("/product_detail.jsp")) { %><div class="col-xs-12" id="productSearchCatDescr"><%=product_catalogue.getColumn("catDescr" + lang)%></div><%}%>
    </div>
