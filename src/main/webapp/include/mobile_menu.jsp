...
<nav id="mobile-menu">
  <ul>
    <li><span style="overflow: visible;"><form id="mobileSearchForm" name="mobileSearchForm" action="<%="/browse/"%>" method="get"><input type="text" name="qid" class="form-control typeahead" placeholder="<%=top_jsp_lb.get("productSearch" + lang)%>"><button class="submit"><span class="glyphicon glyphicon-search"></span></button></form></span></li>
