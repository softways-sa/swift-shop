...
<div id="contentContainer" class="container">
  ...
  <div class="row">
    ...
    <div class="col-sm-6" id="newCustomerWrapper">
      ...
      <div class="clearfix">
        <div class="fl mr"><input type="button" onclick="location.href='<%="/" + "customer_create_account.jsp?target=" + target%>'" value="<%=lb.get("btSubmit" + lang)%>" class="button" /></div>
        <div class="fl"><input type="button" onclick="location.href='<%="/" + "customer.do?cmd=guest_checkout"%>'" value="<%=lb.get("btnGuestCheckout" + lang)%>" class="button" /></div>
      </div>
    </div>
    ...
    <div class="col-sm-6" id="existingCustomerWrapper">
      ...
      <div>
          <form name="signinForm" action="/customer.do" method="POST">
          ...
          <div style="margin-top:15px;"><a href="/customer_forgot_password.jsp" style="text-decoration:underline;"><%=lb.get("forgotPassword" + lang)%></a></div>
